...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/huahua/Library/Python/3.9/lib/python/site-packages/database.sqlite',
        'USER': '',
        'PASSWORD': '',
        'HOST': '',
        'PORT': '',
...
SECRET_KEY = 'gn60jhq(81y&huu5c!evrnyiihx#hn0e*uuv-c^4h)&a-%7^y*'
...
MEDIA_ROOT = '/Users/huahua/Library/Python/3.9/lib/python/site-packages/media'
MEDIA_URL = '/media/'
